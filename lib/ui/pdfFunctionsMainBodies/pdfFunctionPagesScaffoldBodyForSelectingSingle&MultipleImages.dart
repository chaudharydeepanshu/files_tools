            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  color: Colors
                      .white, //widget.mapOfFunctionDetails!['BG Color'] ?? null,
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Material(
                                  elevation: isFilePickingInitiated == false
                                      ? buttonElevation
                                      : 0,
                                  ...
                                  child: InkWell(
                                    ...
                                    hoverColor: widget.mapOfFunctionDetails![
                                        ...
                                        Colors.black.withOpacity(0.1),
                                    child: Container(
                                      height: isFilePicked == true ? null : 75,
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.only(
                                          topLeft: Radius.circular(10),
                                          topRight: Radius.circular(10),
                    ...
                    Expanded(
                      child: ListView(
                        children: List<Widget>.generate(
                            widget.mapOfFunctionDetails!['Sublist Functions']
                                .length, (int index) {
                          return Column(
                            children: [
                              PDFFunctions(
                                ...
                                onTapAction: () => widget.mapOfFunctionDetails![
                                        'Sublist Functions'][index]['Action'](
                                    files,
